...
export const SAMPLE_CATALOG = [
  {
    ...
    notes: 'مهمة مستمرة 24 ساعة مقسمة على ثلاث ورديات متتابعة',
    periods: [
      { id: 'W-P1', name: 'الفترة 1 — المسائية', startTime: '17:00', endTime: '23:00', durationMinutes: 360, dayOffset: 0, driversNeeded: 1 },
      { id: 'W-P2', name: 'الفترة 2 — الفجر', startTime: '05:00', endTime: '11:00', durationMinutes: 360, dayOffset: 1, driversNeeded: 1 },
      { id: 'W-P3', name: 'الفترة 3 — الظهيرة', startTime: '11:00', endTime: '17:00', durationMinutes: 360, dayOffset: 1, driversNeeded: 1 }
    ]
  },
  {
    code: 'PATROL-12H',
    ...
    driversNeeded: 4,
    locationType: 'outdoor',
    notes: 'دورية حراسة ليلية مقسمة على فترتين كل فترة سائقين',
    periods: [
      { id: 'PAT-1', name: 'فترة أول الليل', startTime: '18:00', endTime: '00:00', durationMinutes: 360, dayOffset: 0, driversNeeded: 2 },
      { id: 'PAT-2', name: 'فترة آخر الليل والفجر', startTime: '00:00', endTime: '06:00', durationMinutes: 360, dayOffset: 1, driversNeeded: 2 }
    ]
  },
  {
    code: 'FOREST-24H',
    ...
    periods: [
      { id: 'ALPHA-1', code: 'ALPHA-1', name: 'Alpha — بداية', track: 'ALPHA', startTime: '17:00', endTime: '23:00', durationMinutes: 360, dayOffset: 0, driversNeeded: 1 },
      { id: 'ALPHA-2', code: 'ALPHA-2', name: 'Alpha — فجر', track: 'ALPHA', startTime: '05:00', endTime: '11:00', durationMinutes: 360, dayOffset: 1, driversNeeded: 1 },
      { id: 'ALPHA-3', code: 'ALPHA-3', name: 'Alpha — ظهر', track: 'ALPHA', startTime: '11:00', endTime: '17:00', durationMinutes: 360, dayOffset: 1, driversNeeded: 1 },
      { id: 'MO-1', code: 'MO-1', name: 'MO — بداية', track: 'MO', startTime: '17:00', endTime: '22:30', durationMinutes: 330, dayOffset: 0, driversNeeded: 1 },
      { id: 'MO-2', code: 'MO-2', name: 'MO — صباح', track: 'MO', startTime: '07:30', endTime: '12:00', durationMinutes: 270, dayOffset: 1, driversNeeded: 1 },
      { id: 'MO-3', code: 'MO-3', name: 'MO — ظهر', track: 'MO', startTime: '12:30', endTime: '17:00', durationMinutes: 270, dayOffset: 1, driversNeeded: 1 }
    ]
  },
  { code: 'DUNYA', name: 'دنيا برك', startTime: '12:00', durationMinutes: 600, driversNeeded: 2, locationType: 'outdoor' },
  { code: 'GARDEN', name: 'غاردن سيتي', startTime: '17:00', durationMinutes: 420, driversNeeded: 2, locationType: 'outdoor' },
  { code: 'BAHJA', name: 'البحر بهجة', startTime: '09:00', durationMinutes: 780, driversNeeded: 1, locationType: 'outdoor' },
  { code: 'GUARD', name: 'حراسة مقر', startTime: '17:00', durationMinutes: 420, driversNeeded: 1, locationType: 'indoor' },
  { code: 'RAID', name: 'مداهمات سريعة', startTime: '19:30', durationMinutes: 570, driversNeeded: 2, locationType: 'outdoor' },
  { code: 'DELIV', name: 'توصيل عتاد', startTime: '20:00', durationMinutes: 180, driversNeeded: 1, locationType: 'outdoor' }
];
...
export function getMissionPeriods(m) {
  ...
  if (Array.isArray(m.periods) && m.periods.length > 0) {
    return m.periods.map((p, idx) => ({
      ...
      endTime: p.endTime || fromMinSafe(toMin(p.startTime) + (p.durationMinutes || 0)),
      durationMinutes: p.durationMinutes || 360,
      dayOffset: p.dayOffset || 0,
      driversNeeded: p.driversNeeded || 1,
      orderIndex: idx
    }));
  }
  // Single default period for traditional single-shift tasks
  ...
  return [
    {
      ...
      endTime: fromMinSafe(startMin + dur),
      durationMinutes: dur,
      dayOffset: 0,
